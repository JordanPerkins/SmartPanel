...
$(document).ready(function() {
    ...
    $(".overlay-button").click(function() {
        var a = $(this).attr("data-theme"),
            ...
            d = '<div id="loader-overlay" class="ui-front loader ui-widget-overlay ' + a + " opacity-" + b + '"><img src="images/spinner/loader-' + c + '.gif" alt="" /></div>';
        ...
        var b = $(this).parents(".content-box"),
            ...
            f = '<div id="refresh-overlay" class="ui-front loader ui-widget-overlay ' + c + " opacity-" + d + '"><img src="images/spinner/loader-' + e + '.gif" alt="" /></div>';
