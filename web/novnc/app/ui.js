    ...
    connect: function(event, password) {
      ...
      var result = UI.API2Request({
              ...
              success: function(result) {
                ...
                UI.updateSetting('host', result.host);
                UI.updateSetting('port', result.node_port);
                UI.updateSetting('path', result.path + "?" + wsparams);
                UI.updateSetting('pveticket', result.ticket);
              },
        ...
        var password = UI.getSetting('pveticket');
        console.log(host + " " + port + " " + path + " " + password);
 ...
 * ------v------*/
    ...
    API2Request: function(reqOpts) {
      ...
      if (reqOpts.method === 'GET') {
          xhr.open(reqOpts.method, reqOpts.url + '?' + data);
      } else {
